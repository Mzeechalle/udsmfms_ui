...
const StudentPostponementToPrint = React.forwardRef((props, ref) => {
                        ...
                        </center>
                        {
                            !isLoading ? 
                                <div style={{paddingLeft: 95, paddingRight: 95, textAlign: "justify", textJustify: "inter-word"}}>
                                        ...
                                        <p>Kindly refer to the above heading. I, {student.full_name} with the registration number {student.regno} taking {student.programme} year {student.dof} of study. I am requesting for resume of my studies due to {postponement.reason}</p>
...
export default StudentPostponementToPrint;