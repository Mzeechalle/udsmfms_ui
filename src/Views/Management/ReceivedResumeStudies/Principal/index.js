...
const PrincipalReceivedStudentResumeStudies = () => {

    const [ approvedResumeStudies, setPrincipalAssignedResumeStudies ] = useState([]);
    ...
    useEffect(() => {
        const fetchResumeStudies = async () => {
            ...
            getApprovedStudentResumeStudies(
                "hod",
                (data) => {
                    setPrincipalAssignedResumeStudies(data.submitted);
                    setIsLoading(false);
                    console.log(data);
                },
                (error) => {
...
export default PrincipalReceivedStudentResumeStudies;