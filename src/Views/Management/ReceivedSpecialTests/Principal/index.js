...
const PrincipalReceivedStudentSpecialTests = () => {

    const [ approvedSpecialTests, setPrincipalAssignedSpecialTests ] = useState([]);
    ...
    useEffect(() => {
        const fetchSpecialTests = async () => {
            ...
            getApprovedStudentSpecialTests(
                "hod",
                (data) => {
                    setPrincipalAssignedSpecialTests(data.submitted);
                    setIsLoading(false);
                    console.log(data);
                },
                (error) => {
...
export default PrincipalReceivedStudentSpecialTests;