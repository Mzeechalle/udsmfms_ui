...
const PrincipalReceivedStaffLeaves = () => {

    const [ approvedLeaves, setPrincipalAssignedLeaves ] = useState([]);
    ...
    useEffect(() => {
        const fetchLeaves = () => {
            getApprovedStaffLeaves(
                "hod",
                (data) => {
                    setPrincipalAssignedLeaves(data.submitted);
                    console.log(data);
                },
                (error) => {
                    console.log(error);
...
export default PrincipalReceivedStaffLeaves;