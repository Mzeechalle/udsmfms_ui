...
const PrincipalReceivedStudentPostponements = () => {

    const [ approvedPostponements, setPrincipalAssignedPostponements ] = useState([]);
    ...
    useEffect(() => {
        const fetchPostponements = async () => {
            ...
            getApprovedStudentPostponements(
                "hod",
                (data) => {
                    setPrincipalAssignedPostponements(data.submitted);
                    setIsLoading(false);
                    console.log(data);
                },
                (error) => {
...
export default PrincipalReceivedStudentPostponements;