...
import ResumeStudiesReasonComponent from '../../../../Components/ResumeStudiesReasonComponent';
import ModalComponent from '../../../../Components/ModalComponent';
import { showPosition } from '../../../../Helpers/customFunctions';
import GenerateResumeStudiesPDF from '../../../../Components/GenerateResumeStudiesPDFComponent';

const ViewResumeStudies = () => {
    ...
    useEffect(() => {
        const fetchResumeStudies = () => {
            ...
            getStudentResumeStudiesWithProfileData(
                localStorage.getItem("resumeStudies_id"),
                (data) => {
        ...
        <Row gutter={[8, 8]} style={{width: "100%"}}>
                        ...
                        </center>
                        {
                            !isLoading ? 
                                <div style={{paddingLeft: 95, paddingRight: 95, textAlign: "justify", textJustify: "inter-word"}}>
                                        ...
                                        <p>Kindly refer to the above heading. I, {student.full_name} with the registration number {student.regno} taking {student.programme} of year of study {student.dof}. I am requesting for resume of my studies due to {resumeStudies.reason}</p>
            ...
            <Col xs={24} sm={24} md={6} lg={6}>
                ...
                >
                    ...
                    <Divider style={{color: "gray", fontSize:"14px"}}>Resume of Studies Details</Divider>
                    <p><strong>Reason : </strong> &nbsp; {resumeStudies.reason}</p>
                    {
                        ...
                        <Row gutter={[8, 8]}>
                            ...
                            <ModalComponent
                                modalText={
                                    <ResumeStudiesReasonComponent
                                        resumeStudiesId={localStorage.getItem("resumeStudies_id")}
                        ...
                        :
                        <>
                            <GenerateResumeStudiesPDF resumeStudiesId={localStorage.getItem("resumeStudies_id")}/>
                        </>
                    }
                </Card>
            </Col>
...
export default ViewResumeStudies;