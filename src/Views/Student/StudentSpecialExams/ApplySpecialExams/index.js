...
import { createStudentSpecialExam } from '../../../../Data/Student';

const ApplySpecialExam = () => {
    ...
    return(
        <>
        <Card title="Special Exam Application Form" bordered={true}>
...
export default ApplySpecialExam;