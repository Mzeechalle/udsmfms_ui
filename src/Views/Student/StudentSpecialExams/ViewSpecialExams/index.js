...
import { getStudentSpecialExamById, getStudentSpecialExamWithProfileData, updateStudentSpecialExamProgress } from '../../../../Data/Student';
import SpecialExamReasonComponent from '../../../../Components/SpecialExamReasonComponent';
...
const ViewSpecialExam = () => {
    ...
    const [ specialExamHod, setSpecialExamHoD ] = useState({});
    const [ specialExamMo, setSpecialExamMo ] = useState({});
    ...
    useEffect(() => {
        const fetchSpecialExam = () => {
            setIsLoading(true);
            getStudentSpecialExamWithProfileData(
                localStorage.getItem("specialExam_id"),
                (data) => {
                    console.log(data.specialExam);
                    setStudent(data.student);
                    setDept(data.student.department);
                    setCollege(data.student.college);
                    setContacts(data.student.contacts);
                    setSpecialExam(data.specialExam);
                    setSpecialExamHoD(data.specialExam.hod);
                    setSpecialExamMo(data.specialExam.mo_incharge);
                    setPrincipal(data.specialExam.principal);
                    setDVC(data.specialExam.dvc);
                    setIsLoading(false);
                },
                (error) => {
                    setIsLoading(false);
        ...
        <Row gutter={[8, 8]} style={{width: "100%"}}>
            <Col xs={24} sm={24} md={18} lg={18}>
                ...
                <div>
                        <center>
                            ...
                            <h1><b>APPLICATION FOR SPECIAL EXAM</b></h1>
                        </center>
                        {
                            !isLoading ? 
                                <div style={{paddingLeft: 95, paddingRight: 95, textAlign: "justify", textJustify: "inter-word"}}>
                                        ...
                                        <p>DAR-ES-SALAAM.</p>
                                        <p>Dear Sir/Madam,</p>
                                        <center><h4><u>RE: REQUEST FOR SPECIAL EXAM</u></h4></center>
                                        <p>Kindly refer to the above heading. I, {student.full_name} with the registration number {student.regno} taking {student.programme} year {student.dof} of study. I  Am kindly apologising for 
                                            unintentionally not being able to complete the last examination of {specialExam.course} due to {specialExam.reason}. I 
                                            hereby attach documents for my reference</p>
                                        <p>Therefore, I kindly request for a special exam to be set for me to sit for the examination of {specialExam.course}.</p>
                                            ...
                                            <b>MEDICAL OFFICER INCHARGE USE</b>
                                                <Row>
                                                    <Col xs={24} sm={24} md={18} lg={19}>
                                                        <li>
                                                            {
                                                                (specialExamMo.response === "approved") ?
                                                            ...
                                                            <p><b>{specialExamMo.reason}</b></p>
                                                            <p>Mdeical Officer Incharge <b>Msasu, Alfred John Msasu</b> Date: <b>{specialExamMo.issue_date}</b></p>
                                                        </li>
                                                    </Col>
                                            ...
                                            <b>DEPARTMENT USE</b>
                                                <Row>
                                                    <Col xs={24} sm={24} md={18} lg={19}>
                                                        <li>
                                                            {
                                                                (specialExamHod.response === "approved") ?
                                                                <span>The applicant is recommended/<strike>not recommended</strike> on the ground that*</span>
                                                                :<span>The applicant is <strike>recommended</strike>/not recommended on the ground that*</span>
                                                            }
                                                            <p><b>{specialExamHod.reason}</b></p>
                                                            <p>Head of Department <b>{dept.hod}</b> Date: <b>{specialExamHod.issue_date}</b></p>
                                                        </li>
                                                    </Col>
                                                    <Col xs={24} sm={24} md={18} lg={5}>
                                                    {
            ...
            <Col xs={24} sm={24} md={6} lg={6}>
                ...
                >
                    ...
                    <Divider style={{color: "gray", fontSize:"14px"}}>Special Exam Details</Divider>
                    <p><strong>Reason : </strong> &nbsp; {specialExam.reason}</p>
                    {
                        ...
                        <Row gutter={[8, 8]}>
                            ...
                            <ModalComponent
                                modalText={
                                    <SpecialExamReasonComponent
                                        specialExamId={localStorage.getItem("specialExam_id")}
                        ...
                        :
                        <>
                            <GenerateSpecialExamPDF specialExamId={localStorage.getItem("specialExam_id")}/>
                        </>
                    }
                </Card>
            </Col>
...
export default ViewSpecialExam;